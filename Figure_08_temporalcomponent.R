...
pdf("plots/Figure08-1.pdf", width = 4.5, height = 9)
  par(mfrow = c(4, 1))
  ExpecSTnet_plot(smnet_fit_99, plot_fig = "seasonal")
  ExpecSTnet_plot(smnet_fit_90, plot_fig = "seasonal")
  ExpecSTnet_plot(smnet_fit_50, plot_fig = "seasonal")
  ExpecSTnet_plot(smnet_fit_10, plot_fig = "seasonal")
dev.off()

pdf("plots/Figure08-2.pdf", width = 4.5, height = 9)
  par(mfrow = c(4, 1))
  ExpecSTnet_plot(smnet_fit_99, plot_fig = "trend")
  ExpecSTnet_plot(smnet_fit_90, plot_fig = "trend")
  ExpecSTnet_plot(smnet_fit_50, plot_fig = "trend")
  ExpecSTnet_plot(smnet_fit_10, plot_fig = "trend")
dev.off()
